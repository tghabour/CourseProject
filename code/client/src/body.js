...
export function Result(props) {
    return (
        <div className='button flex flex-col hover:bg-orange-50 rounded p-3 object-fit'>
            <a href='/test' className='hover:underline text-sky-400 visited:text-indigo-800'>{props.title}</a>
